...
## Linguagem ubíqua
> Mesmo vocabulário entre negócio, spec e código. Promova ao `docs/glossario.md` global.
...
Anti-Corruption Layer, Shared Kernel? Atualize `docs/arquitetura/mapa-de-contexto.md`.>
