...
> Termos específicos desta feature. Termo novo → **promova ao `docs/glossario.md`** (linguagem ubíqua).
...
## Roadmap da feature
> Fases/ondas de entrega desta feature. A Onda 1 alimenta o `docs/produto/roadmap.md` global.
...
> Decisões difíceis de reverter tomadas aqui → registre como ADR em `docs/arquitetura/adr/`.
