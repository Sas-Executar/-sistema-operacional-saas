...
> Uma task só vira `done` quando o **gate passa** (comandos em `docs/arquitetura/engenharia/TESTING.md`) — não por
...
- [ ] `docs/operacao/estado.md` atualizado (próximo passo / decisões)
