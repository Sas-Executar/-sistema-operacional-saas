...
|---|---|---|
| Decisão difícil de reverter | ADR (`docs/arquitetura/adr/`) | ✅ |
| Termo/conceito de negócio | `docs/glossario.md` | ✅ |
| Convenção de código/agente | `CLAUDE.md` | ✅ |
| Padrão de teste/quality gate | `docs/arquitetura/engenharia/TESTING.md` | ✅ |
...
- <YYYY-MM-DD: "<lição>" → [ADR-NNNN](arquitetura/adr/NNNN-*.md) / glossary / CLAUDE.md>
