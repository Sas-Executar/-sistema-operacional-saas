...
## Regras
- Siga `CLAUDE.md` e a linguagem ubíqua do `docs/glossario.md`.
...
`docs/arquitetura/engenharia/TESTING.md` e a **spec/design relevantes** — **não** o histórico de chat nem outras tasks.
