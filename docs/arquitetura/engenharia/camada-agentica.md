...
`.claude/agents/<nome>.md` (ver `docs/arquitetura/engenharia/_templates/subagent.template.md`). Exemplos típicos:
...
`.claude/skills/<nome>/SKILL.md` (ver `docs/arquitetura/engenharia/_templates/skill.template.md`). Exemplos:
...
| **`/handoff`** | pausa/retoma via `docs/operacao/estado.md` (continuidade) |
