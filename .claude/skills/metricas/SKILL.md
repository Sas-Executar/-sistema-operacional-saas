...
- Ligação com o gate: cobertura abaixo do mínimo ou finding **bloqueante** barra o merge (ver
  `docs/arquitetura/engenharia/TESTING.md`); o resto entra aqui como **tendência** a vigiar (dívida acumulando?).
...
## Saída
- Atualize `docs/arquitetura/engenharia/metrics.md` (tabelas + tendência + data e período), incluindo a seção
  **Qualidade de código**.
