...
justificativa (qual insumo motiva cada item), gere só o aprovado.** Referência: `docs/arquitetura/engenharia/agentic-layer.md`.
...
- **Agents (subagentes)** em `.claude/agents/<nome>.md` (use `docs/arquitetura/engenharia/_templates/subagent.template.md`):
  ex. `spec-reviewer` (gate DoR), `domain-modeler`, `adr-writer`, `<stack>-tester`.
- **Skills** em `.claude/skills/<nome>/` (use `docs/arquitetura/engenharia/_templates/skill.template.md`): conforme as
...
- Mapeie cada artefato em `docs/arquitetura/engenharia/agentic-layer.md`.
