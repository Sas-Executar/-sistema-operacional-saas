...
- **Sempre:** `docs/operacao/estado.md` (todos soltos, ideias adiadas) e pendências de `integrations.md`.
- **Capacidade:** Throughput recente em `docs/arquitetura/engenharia/metrics.md` (via `/metricas`) — dimensione
...
## Saída
- `docs/produto/roadmap.md` (use `docs/produto/_templates/roadmap.template.md`).
