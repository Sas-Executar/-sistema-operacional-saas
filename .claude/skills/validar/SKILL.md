---
name: validar
description: Use APÓS implementar uma feature para validá-la (UAT) — roda os gates de docs/arquitetura/engenharia/TESTING.md, mapeia cada AC-N ao seu teste e aponta ACs sem cobertura, resolve SPEC_DEVIATION pendente, checa o Definition of Done e atualiza docs/operacao/estado.md. Acione com /validar.
---
...
2. **Rode os gates** de `docs/arquitetura/engenharia/TESTING.md` (e os comandos da coluna Gate do `tasks.md`). O `/verify`
...
6. **Atualize `docs/operacao/estado.md`** (próximo passo / decisões) — ou rode `/handoff` para encerrar.
