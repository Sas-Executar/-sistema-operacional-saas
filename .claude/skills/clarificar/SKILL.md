...
- **Direcione ao destino certo** conforme o que foi clarificado:
  ...
  - virou **decisão difícil de reverter** → vira **ADR** (`docs/arquitetura/adr/`);
  - virou **termo de negócio** → `docs/glossario.md` / `domain.md`;
  - ficou **em aberto de propósito** → `docs/operacao/estado.md` (com o gatilho para reconsiderar).
