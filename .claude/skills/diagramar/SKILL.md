...
- `docs/produto/visao.md` — atores/personas e propósito do sistema.
- `docs/arquitetura/mapa-de-contexto.md` — bounded contexts e relações (DDD).
- `specs/*/design.md` — containers, serviços e integrações.
- `docs/arquitetura/assessment.md` — as-is, no brownfield.
...
## Saída
- Escreva/atualize `docs/arquitetura/diagrams.md` (já existe como placeholder; mantenha o
