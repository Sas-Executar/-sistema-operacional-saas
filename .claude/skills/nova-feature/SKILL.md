...
3. **`domain.md`** (arquitetural) — bounded context, linguagem ubíqua, agregados, eventos.
   Atualize `docs/glossario.md` e `docs/arquitetura/mapa-de-contexto.md` se surgirem termos/fronteiras.
...
`docs/arquitetura/engenharia/TESTING.md`, mapeia `AC-N → teste`, resolve `SPEC_DEVIATION`, checa o Definition of Done e
atualiza `docs/operacao/estado.md`. Encerre com `/handoff` se for pausar.
