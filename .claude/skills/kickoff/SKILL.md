...
→ Saídas: `docs/arquitetura/assessment.md` (as-is + gaps) e a lista de ADRs retroativos.
...
|---|---|---|
| `docs/produto/visao.md` | greenfield | `docs/produto/_templates/vision.template.md` |
| `docs/produto/stakeholders.md` | greenfield | `docs/produto/_templates/stakeholders.template.md` |
| `docs/produto/journeys.md` | greenfield | `docs/produto/_templates/journeys.template.md` |
| `docs/produto/features.md` | greenfield | `docs/produto/_templates/features.template.md` (classificadas + sequenciadas) |
| `docs/produto/mvp-canvas.md` | greenfield | `docs/produto/_templates/mvp-canvas.template.md` |
| `docs/arquitetura/assessment.md` | brownfield | `docs/arquitetura/_templates/assessment.template.md` |
| `docs/arquitetura/mapa-de-contexto.md` | ambos | existente (inicial no greenfield; reverse-engineered no brownfield) |
| `docs/arquitetura/overview.md` | ambos | existente — consolide os **5 eixos** + segurança + operacional, com links para ADRs/context-map/diagrams/TESTING |
| `docs/glossario.md` | ambos | existente (semeie os termos centrais) |
...
| `docs/arquitetura/adr/NNNN-*.md` | ambos | `docs/arquitetura/adr/_template.md` (um por decisão estrutural; retroativos no brownfield) |
| `docs/produto/roadmap.md` | ambos | `docs/produto/_templates/roadmap.template.md` |

> `docs/arquitetura/engenharia/integrations.md` e `.mcp.json` são gerados pela skill `/integracoes`, não aqui.
...
gere só o aprovado. Itens não aprovados viram itens do roadmap (Fase 5). Ref.: `docs/arquitetura/engenharia/agentic-layer.md`.
